    ...
    <StoryShell page={page}>
      <section className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
        <div className="pb-4">
          ...
          <h1 className="mt-8 max-w-3xl text-4xl font-semibold leading-tight tracking-normal text-[#1f1a17] md:text-6xl">
            {page.title}
          </h1>
          <p className="mt-6 max-w-2xl text-2xl leading-10 text-[#3a3029]">
            {page.hook}
          </p>
        </div>
  ...
  return (
    <article className="overflow-hidden rounded-[1.5rem] border border-[#d8ccbb] bg-[#f7f1e8] p-5 text-[#2a211c] shadow-[0_22px_55px_rgba(42,33,28,0.08)]">
      ...
      <div className="mt-7 overflow-x-auto">
        <div className="min-w-[586px]">
          <div className="grid grid-cols-[minmax(420px,1fr)_150px] items-start gap-x-4 gap-y-3">
            <div>
            ...
            <div>
              ...
              <p className="mt-2 text-center font-mono text-xs">连续动作</p>
            </div>

            <div>
              <div className="flex h-[10rem] flex-col justify-between rounded-[0.5rem] border border-[#2a211c] bg-[#9fcad2] p-2">
                <div className="flex gap-1.5">
                  {Array.from({ length: 16 }).map((_, index) => (
                    <span
                      key={index}
                      className="h-2.5 flex-1 rounded-full border border-[#2a211c]/70 bg-[#bfe0e5]"
                    />
                  ))}
                </div>
                <div className="my-3 rounded-[0.5rem] border border-[#2a211c] bg-[#fffaf4] px-5 py-4 text-center">
                  <p className="font-mono text-sm font-semibold">预训练 VLA</p>
                  <p className="mt-1 font-mono text-xs text-[#6c6258]">
                    视觉编码器 + LLM / VLA 骨干
                  </p>
                </div>
                <div className="flex gap-1.5">
              ...
              <div className="mt-4 grid grid-cols-[220px_150px] justify-center gap-3">
                <div>
                  <div
                    className="mx-auto h-5 w-[36%] rounded-t-[0.35rem] border border-[#2a211c] bg-[#9cc9d2]"
                    style={{
                ...
                <div className="mt-[2.25rem] flex h-16 w-[150px] items-center justify-center gap-1 rounded-[0.5rem] border border-dashed border-[#2a211c] bg-[#fff7be] px-2 text-center font-mono text-[0.6rem]">
                  <span className="whitespace-nowrap">当前帧指令</span>
            ...
            <div className="flex flex-col">
              <div className="flex h-[10rem] flex-col justify-between rounded-[0.5rem] border border-[#2a211c] bg-[#dbe9d5] p-2">
                <div className="grid grid-cols-4 gap-1.5">
                  {Array.from({ length: 8 }).map((_, index) => (
                    <span
                      key={index}
                      className="h-5 rounded-[0.3rem] border border-[#2a211c]/45 bg-[#eef5e9]"
                    />
                  ))}
                </div>
                <div className="rounded-[0.45rem] border border-[#2a211c] bg-[#fffaf4] px-2 py-2 text-center">
                  <p className="font-mono text-xs font-semibold">动作头</p>
                  <p className="font-mono text-[0.65rem] text-[#665c52]">
                    动作专家
                  </p>
                </div>
                <div className="grid grid-cols-4 gap-1.5">
